...
<body>
<form method='post' action='award_marks.php' name='frm'>
<div align='center'>
<table border='2' width='20%'>
<tr><th colspan='2'><?php  echo ucwords($cname);?> Award Judging Stats</th></tr>
<tr><th>Marks</th><th>Number of photos</th></tr>
<?php 
if($opt==1 && isset($_POST['submit']))
{
 for($i=5;$i<=15;$i++)
 {
...
<a href='award_menu.php?sub=1'><input type='button' name='back' value='Back' /></a></td>
</tr>
 </table>
